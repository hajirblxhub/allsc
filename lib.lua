...
NoxiusLib.Icons = Icons

function NoxiusLib:CreateWindow(options)
    
	options = options or {}
	local TitleName = options.Name or "NoxiusHub"
	...
	local Logo = Create("ImageLabel", {
		...
		Image = "rbxassetid://7719400892819",
	...
	function Window:Notify(options)
		...
		local Image = options.Image or options.Icon or "rbxassetid://7719400892819"
...
function NoxiusLib:Destroy()
	...
	if RunService:IsStudio() then
		local gui = Players.LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("NoxiusHub")
		if gui then gui:Destroy() end
	else
		local gui = CoreGui:FindFirstChild("NoxiusHub")
		if gui then gui:Destroy() end
	end
end
